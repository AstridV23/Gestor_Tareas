...
export default function Login({ toggleAuthPage }: signinProp) {
    ...
    return (
            <div className="bg-amber-50 max-w-sm w-[%90] p-8 rounded-lg shadow-lg">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button className="bg-blue-400 my-2 py-2 flex px-10 rounded-full text-white text-bold cursor-pointer">
                        Ingresar
                    </button>

                    <div className="my-4 flex justify-center text-sm">
                        <p>😲📭Aún no tienes una cuenta?</p>
                        <p onClick={() => toggleAuthPage()} className="ml-1 text-blue-500 cursor-pointer">Registrarse</p>
                    </div>
